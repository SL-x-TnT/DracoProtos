namespace DracoProtos.Core.Base
{
    public enum ArtifactName
	{
		...
		ARTIFACT_BETTER_CREATURES_FROM_EGGS_1,
		ARTIFACT_ATTACKER_SINGLE_CP_BOOST_1,
		ARTIFACT_RESIST_BOOST_1,
		ARTIFACT_CHOOSE_GOLDEN_EGG_CREATURE_1,
		ARTIFACT_MORE_TIME_FOR_DODGE_1,
		ARTIFACT_PROTECT_FROM_CHAMPIONS_1,
		ARTIFACT_INCREASE_RANGE_1
	}
}
